...
<!-- <div id="services" class="container-fluid text-center">
  ...
  <div class="row slideanim">
    ...
    <div class="col-sm-4">
      ...
      <h4>LOVE</h4>
      <p>We love customer satisfaction..</p>
    </div>
    <div class="col-sm-4">
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  ...
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="port1.jpg" alt="Paris" width="400" height="300">
        
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="port2.jpg" alt="New York" width="400" height="300">
        
      </div>
    </div>
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="port3.jpeg" alt="San Francisco" width="400" height="300">
...
<div id="pricing" class="container-fluid">
  ...
  <div class="row slideanim">
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <h1>Retailer Registration/Login</h1>
        </div>
    ...
    <div class="col-sm-4 col-xs-12">
      <div class="panel panel-default text-center">
        <div class="panel-heading">
          <h1>Customer Registration/Login</h1>
        </div>
        <div class="panel-body">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-envelope"></span> alluaravind@gmail.com</p>
    </div>
...
<footer class="container-fluid text-center">
  ...
  <p>Bootstrap Theme Made By <a href="https://www.w3schools.com" title="Visit w3schools">Allu Aravind</a></p>
</footer>
