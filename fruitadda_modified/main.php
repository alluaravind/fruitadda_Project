...
<nav class="navbar navbar-expand-lg navbar-dark default-color-dark fixed-top">
	<img src="images/fruiticon.jpg" width="40px" height="30px">
    <a class="navbar-brand" href="sellerdashboard.php">FRUITS ADDA</a>
    ...
    <div class="collapse navbar-collapse " id="navbarSupportedContent">
         ...
         <ul class="navbar-nav ml-auto nav-flex-icons">
            ...
            <li class="nav-item">
                <div class="nav-link waves-effect waves-light">Wallet 0$&nbsp;<img src="images/wallet.png" width="25px" height="20px">&nbsp;&nbsp;</div>
            </li>
            <li class="nav-item">
